Shader "Unlit/quillTerrain_8Biome"{
  Properties {
    ...
    _DesertFresnelColor("_DesertFresnelColor",Color) = (1,1,1,1)

    _DesertBaseColor("_DesertBaseColor",Color) = (1,1,1,1)
    _DesertSpecularColor1("_DesertSpecularColor1",Color) = (1,1,1,1)

    _DesertSpecularColor2("_DesertSpecularColor2",Color) = (1,1,1,1)
    _DesertStriationColorLight("_DesertStriationColorLight",Color) = (1,1,1,1)
    _DesertStriationColorDark("_DesertStriationColorDark",Color) = (1,1,1,1)
    _DesertStriationSize("_DesertStriationSize", Vector) = (1,1,1)
    _DesertStriationColorSteps("_DesertStriationColorSteps",float) = 4
    _DesertStriationVerticalCutoff("_DesertStriationVerticalCutoff",float) = .5


    _DesertSaturation("_DesertSaturation",float) = 1
    _DesertBrightness("_DesertBrightness",float) = 1
    _DesertMatchMultiplier("_DesertMatchMultiplier",float) = 1 
    _DesertShadowBase("_DesertShadowBase",float) = 1
    _DesertSpecularPower1("_DesertSpecularPower1",float) = 1
    _DesertSpecularPower2("_DesertSpecularPower2",float) = 1
    _DesertSpecularPower2("_DesertSpecularPower2",float) = 1



    _CanyonFresnelColor("_CanyonFresnelColor",Color) = (1,1,1,1)

    _CanyonBaseColor("_CanyonBaseColor",Color) = (1,1,1,1)
    _CanyonSpecularColor1("_CanyonSpecularColor1",Color) = (1,1,1,1)

    _CanyonSpecularColor2("_CanyonSpecularColor2",Color) = (1,1,1,1)
    _CanyonStriationColorLight("_CanyonStriationColorLight",Color) = (1,1,1,1)
    _CanyonStriationColorDark("_CanyonStriationColorDark",Color) = (1,1,1,1)
    _CanyonStriationSize("_CanyonStriationSize", Vector) = (1,1,1)
    _CanyonStriationColorSteps("_CanyonStriationColorSteps",float) = 4
    _CanyonStriationVerticalCutoff("_CanyonStriationVerticalCutoff",float) = .5


    _CanyonSaturation("_CanyonSaturation",float) = 1
    _CanyonBrightness("_CanyonBrightness",float) = 1
    _CanyonMatchMultiplier("_CanyonMatchMultiplier",float) = 1 
    _CanyonShadowBase("_CanyonShadowBase",float) = 1
    _CanyonSpecularPower1("_CanyonSpecularPower1",float) = 1
    _CanyonSpecularPower2("_CanyonSpecularPower2",float) = 1
    _CanyonSpecularPower2("_CanyonSpecularPower2",float) = 1
    ...
    _CanyonTexture("CanyonTexture", 2D) = "white" {}
    _DesertTexture("DesertTexture", 2D) = "white" {}
    _ForestTexture("ForestTexture", 2D) = "white" {}
    _IslandTexture("IslandTexture", 2D) = "white" {}
    _CaveTexture("CaveTexture", 2D) = "white" {}
    _ValleyTexture("ValleyTexture",2D) = "white" {}
    _BaseTexture("BaseTexture",2D) = "white" {}

    _MountainColor("MountainColor", Color) = (1,1,1,1)
    _CanyonColor("CanyonColor", Color) = (1,1,1,1)
    _DesertColor("DesertColor", Color) = (1,1,1,1)
    _ForestColor("ForestColor", Color) = (1,1,1,1)
    _IslandColor("IslandColor", Color) = (1,1,1,1)
    _CaveColor("_CaveColor", Color) = (1,1,1,1)
    _ValleyColor("ValleyColor", Color) = (1,1,1,1)
    _BaseColor("BaseColor", Color) = (1,1,1,1)


    _MountainFlatColor("MountainFlatColor", Color) = (1,1,1,1)
    _CanyonFlatColor("CanyonFlatColor", Color) = (1,1,1,1)
    _DesertFlatColor("DesertFlatColor", Color) = (1,1,1,1)
    _ForestFlatColor("ForestFlatColor", Color) = (1,1,1,1)
    _IslandFlatColor("IslandFlatColor", Color) = (1,1,1,1)
    _CaveFlatColor("_CaveFlatColor", Color) = (1,1,1,1)
    _ValleyFlatColor("ValleyFlatColor", Color) = (1,1,1,1)
    _BaseFlatColor("BaseFlatColor", Color) = (1,1,1,1)


    
    _MountainSpecialColor("MountainSpecialColor", Color) = (1,1,1,1)
    _CanyonSpecialColor("CanyonSpecialColor", Color) = (1,1,1,1)
    _DesertSpecialColor("DesertSpecialColor", Color) = (1,1,1,1)
    _ForestSpecialColor("ForestSpecialColor", Color) = (1,1,1,1)
    _IslandSpecialColor("IslandSpecialColor", Color) = (1,1,1,1)
    _CaveSpecialColor("CaveSpecialColor", Color) = (1,1,1,1)
    _ValleySpecialColor("ValleySpecialColor", Color) = (1,1,1,1)
    _BaseSpecialColor("BaseSpecialColor", Color) = (1,1,1,1)


    
    _MountainLowAltitudeColor("MountainLowAltitudeColor", Color) = (1,1,1,1)
    _CanyonLowAltitudeColor("CanyonLowAltitudeColor", Color) = (1,1,1,1)
    _DesertLowAltitudeColor("DesertLowAltitudeColor", Color) = (1,1,1,1)
    _ForestLowAltitudeColor("ForestLowAltitudeColor", Color) = (1,1,1,1)
    _IslandLowAltitudeColor("IslandLowAltitudeColor", Color) = (1,1,1,1)
    _CaveLowAltitudeColor("_CaveLowAltitudeColor", Color) = (1,1,1,1)
    _ValleyLowAltitudeColor("ValleyLowAltitudeColor", Color) = (1,1,1,1)
    _BaseLowAltitudeColor("BaseLowAltitudeColor", Color) = (1,1,1,1)

    
    _MountainHighAltitudeColor("MountainHighAltitudeColor", Color) = (1,1,1,1)
    _CanyonHighAltitudeColor("CanyonHighAltitudeColor", Color) = (1,1,1,1)
    _DesertHighAltitudeColor("DesertHighAltitudeColor", Color) = (1,1,1,1)
    _ForestHighAltitudeColor("ForestHighAltitudeColor", Color) = (1,1,1,1)
    _IslandHighAltitudeColor("IslandHighAltitudeColor", Color) = (1,1,1,1)
    _CaveHighAltitudeColor("_CaveHighAltitudeColor", Color) = (1,1,1,1)
    _ValleyHighAltitudeColor("ValleyHighAltitudeColor", Color) = (1,1,1,1)
    _BaseHighAltitudeColor("BaseHighAltitudeColor", Color) = (1,1,1,1)



    
    _MountainLowHigh("MountainLowHigh", Vector) = (700,1000,0,0)
    _CanyonLowHigh("CanyonLowHigh", Vector) = (700,1000,0,0)
    _DesertLowHigh("DesertLowHigh", Vector) = (700,1000,0,0)
    _ForestLowHigh("ForestLowHigh", Vector) = (700,1000,0,0)
    _IslandLowHigh("IslandLowHigh", Vector) = (700,1000,0,0)
    _CaveLowHigh("_CaveLowHigh", Vector) = (700,1000,0,0)
    _ValleyLowHigh("ValleyLowHigh", Vector) = (700,1000,0,0)
    _BaseLowHigh("BaseLowHigh", Vector) = (700,1000,0,0)
    ...
    _TerrainTexture1("Terrain Texture 1", 2D) = "white" {}
  ...
  SubShader{
    ...
    Pass{
      ...
      float _DesertMatchMultiplier; 
      float _DesertShadowBase;
      float4 _DesertFresnelColor;

      float _DesertSaturation;
      float _DesertBrightness;

      float4 _DesertBaseColor;
      float4 _DesertSpecularColor1;
      float _DesertSpecularPower1;

      float4 _DesertSpecularColor2;
      float _DesertSpecularPower2;


      float4 _DesertStriationColorLight;
      float4 _DesertStriationColorDark;
      float3 _DesertStriationSize;
      float _DesertStriationColorSteps;
      float _DesertStriationVerticalCutoff;


      float _CanyonMatchMultiplier; 
      float _CanyonShadowBase;
      float4 _CanyonFresnelColor;

      float _CanyonSaturation;
      float _CanyonBrightness;

      float4 _CanyonBaseColor;
      float4 _CanyonSpecularColor1;
      float _CanyonSpecularPower1;

      float4 _CanyonSpecularColor2;
      float _CanyonSpecularPower2;


      float4 _CanyonStriationColorLight;
      float4 _CanyonStriationColorDark;
      float3 _CanyonStriationSize;
      float _CanyonStriationColorSteps;
      float _CanyonStriationVerticalCutoff;
      ...
      sampler2D _CanyonTexture;
      sampler2D _DesertTexture;
      sampler2D _ForestTexture;
      sampler2D _IslandTexture;
      sampler2D _CaveTexture;
      ...
      float4 _MountainFlatColor;
      float4 _CanyonFlatColor;
      float4 _DesertFlatColor;
      float4 _ForestFlatColor;
      float4 _IslandFlatColor;
      float4 _CaveFlatColor;
      float4 _ValleyFlatColor;
      float4 _BaseFlatColor;

      float4 _MountainSteepColor;
      float4 _CanyonSteepColor;
      float4 _DesertSteepColor;
      float4 _ForestSteepColor;
      float4 _IslandSteepColor;
      float4 _CaveSteepColor;
      float4 _ValleySteepColor;
      float4 _BaseSteepColor;


      float4 _MountainSpecialColor;
      float4 _CanyonSpecialColor;
      float4 _DesertSpecialColor;
      float4 _ForestSpecialColor;
      float4 _IslandSpecialColor;
      float4 _CaveSpecialColor;
      float4 _ValleySpecialColor;
      float4 _BaseSpecialColor;


      
      float4 _MountainLowAltitudeColor;
      float4 _CanyonLowAltitudeColor;
      float4 _DesertLowAltitudeColor;
      float4 _ForestLowAltitudeColor;
      float4 _IslandLowAltitudeColor;
      float4 _CaveLowAltitudeColor;
      float4 _ValleyLowAltitudeColor;
      float4 _BaseLowAltitudeColor;

      

      float4 _MountainHighAltitudeColor;
      float4 _CanyonHighAltitudeColor;
      float4 _DesertHighAltitudeColor;
      float4 _ForestHighAltitudeColor;
      float4 _IslandHighAltitudeColor;
      float4 _CaveHighAltitudeColor;
      float4 _ValleyHighAltitudeColor;
      float4 _BaseHighAltitudeColor;


      
      float4 _MountainLowHigh;
      float4 _CanyonLowHigh;
      float4 _DesertLowHigh;
      float4 _ForestLowHigh;
      float4 _IslandLowHigh;
      float4 _CaveLowHigh;
      float4 _ValleyLowHigh;
      float4 _BaseLowHigh;
      ...
      */
      ...
      float3 DoDesertColor(float3 pos, float3 baseNor, float3 nor, float3 eye ,float shadow,float4 data){



        float3 col = _DesertBaseColor;
        ...
        col +=  shadow* _DesertSpecularColor1  * floor( pow(spec,10) * 3) * _DesertSpecularPower1;
        ...
        col += shadow * _DesertSpecularColor2  *  floor( pow(spec,100) * 3) * _DesertSpecularPower2;

        // canyon
        if( dot( nor , float3(0,1,0)) < _DesertStriationVerticalCutoff ){

          col = float3(1,.3,.1);

          float noiseVal = noise( pos * _DesertStriationSize);//snoise( pos * _DesertStriationSize );

          noiseVal = floor( ((noiseVal +1 )/2) * _DesertStriationColorSteps ) / _DesertStriationColorSteps;

          col = lerp( _DesertStriationColorLight , _DesertStriationColorDark , noiseVal);
        ...
        col *= ((floor(lMap * 4 ) /4 ) * _DesertMatchMultiplier + _DesertShadowBase);

        col += _DesertFresnelColor*2*floor(pow(saturate((1-m)),10) * 4)/4;

        col = col * _DesertSaturation + 1-_DesertSaturation;
        col *= _DesertBrightness;
      ...
      */
      ...
      float3 DoCanyonColor(float3 pos, float3 baseNor, float3 nor, float3 eye ,float shadow,float4 data){



        float3 col = _CanyonBaseColor;
        float3 refl = normalize(reflect( -eye, nor  ));
        ...
        float3 spec = dot(refl, _WorldSpaceLightPos0.xyz); 
        col +=  shadow* _CanyonSpecularColor1  * floor( pow(spec,10) * 3) * _CanyonSpecularPower1;
        ...
        col += shadow * _CanyonSpecularColor2  *  floor( pow(spec,100) * 3) * _CanyonSpecularPower2;

        // canyon
        if( dot( nor , float3(0,1,0)) < _CanyonStriationVerticalCutoff ){

          col = float3(1,.3,.1);

          float noiseVal = noise( pos * _CanyonStriationSize);//snoise( pos * _CanyonStriationSize );

          noiseVal = floor( ((noiseVal +1 )/2) * _CanyonStriationColorSteps ) / _CanyonStriationColorSteps;

          col = lerp( _CanyonStriationColorLight , _CanyonStriationColorDark , noiseVal);
        ...
        col *= ((floor(lMap * 4 ) /4 ) * _CanyonMatchMultiplier + _CanyonShadowBase);

        col += _CanyonFresnelColor*2*floor(pow(saturate((1-m)),10) * 4)/4;

        col = col * _CanyonSaturation + 1-_CanyonSaturation;
        col *= _CanyonBrightness;
      ...
      */
      ...
      float3 DoMountainColor(float3 pos,float3 baseNor, float3 nor, float3 eye ,float shadow,float4 data){
        ...
        for( int i =0; i < 3; i++){
          ...
          float4 tMap =0;
          tMap += tex2D(_MountainTexture,  rotateUV(pos.y * .001 + nor.y * .003 ,fPos.xz * .01 + fi * .1)) * .2;
        ...
        // meadow;
        if( baseVert > .95 ){
          col *= (m4+.5)*_MountainColor;//4*float3(.3,1,.1);
        }
      ...
      */
      ...
      float3 DoIslandColor(float3 pos,float3 baseNor, float3 nor, float3 eye ,float shadow,float4 data){
        ...
        for( int i =0; i < 3; i++){
          ...
          float4 tMap =0;
          tMap += tex2D(_IslandTexture,  rotateUV(pos.y * .001 + nor.y * .003 ,fPos.xz * .01 + fi * .1)) * .2;
        ...
        // meadow;
        if( baseVert > .95 ){
          col *= (m4+.5)*_IslandColor;//4*float3(.3,1,.1);
        }
      ...
      */
      ...
      float3 DoCaveColor(float3 pos,float3 baseNor, float3 nor, float3 eye ,float shadow,float4 data){
        ...
        for( int i =0; i < 3; i++){
          ...
          float4 tMap =0;
          tMap += tex2D(_CaveTexture,  rotateUV(pos.y * .001 + nor.y * .003 ,fPos.xz * .01 + fi * .1)) * .2;
        ...
        // meadow;
        if( baseVert > .95 ){
          col *= (m4+.5)*_CaveColor;//4*float3(.3,1,.1);
        }
      ...
      */
      ...
      float3 DoValleyColor(float3 pos,float3 baseNor, float3 nor, float3 eye ,float shadow,float4 data){
        ...
        for( int i =0; i < 3; i++){
          ...
          float4 tMap =0;
          tMap += tex2D(_ValleyTexture,  rotateUV(pos.y * .001 + nor.y * .003 ,fPos.xz * .01 + fi * .1)) * .2;
        ...
        float altitudeValue =  clamp( (pos.y - _ValleyLowHigh.x) / (_ValleyLowHigh.y - _ValleyLowHigh.x),0,1);

        float3 altitudeColor = lerp( _ValleyLowAltitudeColor , _ValleyHighAltitudeColor , altitudeValue);
        ...
        // meadow;
        if( baseVert > .95 ){
          col *= (m4+.5)*_ValleyColor;//4*float3(.3,1,.1);
          }else{
        ...
        float wetness = data.x;
        float erosion = data.z;
        float roughness = data.y;
        if(erosion > .1 ){
          col += erosion *float3(.2,0.3,.25);
        }
        if(pos.y > 100 ){
        ...
        col = col + col *roughness;

        // snow
        if( pos.y + triNoise3D(pos * .004,0,0) * 200 - lMapB * 10 > 400 &&  ( baseVert  + pos.y * .0001> .8)){
          col = col * .2 + .9;
        }
        ...
        // col = float3(1,0,0);
        // col = altitudeValue;
        // col = clamp( (pos.y - _ValleyLowHigh.x) / (_ValleyLowHigh.y - _ValleyLowHigh.x),0,1);
        return col;
      ...
      */
      ...
      float3 DoBaseColor(float3 pos,float3 baseNor, float3 nor, float3 eye ,float shadow,float4 data){
        ...
        for( int i =0; i < 3; i++){
          ...
          float4 tMap =0;
          tMap += tex2D(_BaseTexture,  rotateUV(pos.y * .001 + nor.y * .003 ,fPos.xz * .01 + fi * .1)) * .2;
        ...
        // meadow;
        if( baseVert > .95 ){
          col *= (m4+.5)*_BaseColor;//4*float3(.3,1,.1);
        }
      ...
      float3 DoForestColor(float3 pos, float3 baseNor, float3 nor, float3 eye ,float shadow,float4 data){
      ...
      float4 frag (varyings v) : COLOR {
        ...
        float4 data = tex2D(_DataTexture, float2(0,1) + float2(1,-1)*v.uv);

        float2 normalizedBiomeWeights = normalize(maxBiomeWeights);

        if( maxBiomeWeightsID.x == 0 ){
          color1 = DoMountainColor( v.worldPos, v.nor,fNor,eye,shadow ,data);
        }

        if( maxBiomeWeightsID.x == 1  ){
          color1 = DoCanyonColor( v.worldPos, v.nor,fNor,eye,shadow,data);
        }
        
        if(  maxBiomeWeightsID.x == 2 ){
          color1 = DoDesertColor( v.worldPos, v.nor,fNor,eye,shadow,data);
        }

        if( maxBiomeWeightsID.x == 3  ){
          color1 = DoForestColor( v.worldPos, v.nor,fNor,eye,shadow,data);
        }

        if( maxBiomeWeightsID.x == 4  ){
          color1 = DoIslandColor( v.worldPos, v.nor,fNor,eye,shadow,data);
        }


        if( maxBiomeWeightsID.x == 5 ){
          color1 = DoCaveColor( v.worldPos, v.nor,fNor,eye,shadow,data);
        }

        if( maxBiomeWeightsID.x == 6 ){
          color1 = DoValleyColor( v.worldPos, v.nor,fNor,eye,shadow,data);
        }

        if( maxBiomeWeightsID.x == 7 ){
          color1 = DoBaseColor( v.worldPos, v.nor,fNor,eye,shadow,data);
        }



        if( maxBiomeWeightsID.y == 0 ){
          color2 = DoMountainColor( v.worldPos, v.nor,fNor,eye,shadow,data);
        }

        if( maxBiomeWeightsID.y == 1  ){
          color2= DoCanyonColor( v.worldPos, v.nor,fNor,eye,shadow,data);
        }
        
        if(  maxBiomeWeightsID.y == 2 ){
          color2= DoDesertColor( v.worldPos, v.nor,fNor,eye,shadow,data);
        }

        if( maxBiomeWeightsID.y == 3  ){
          color2= DoForestColor( v.worldPos, v.nor,fNor,eye,shadow,data);
        }

        if( maxBiomeWeightsID.y == 4  ){
          color2= DoIslandColor( v.worldPos, v.nor,fNor,eye,shadow,data);
        }


        if( maxBiomeWeightsID.y == 5 ){
          color2= DoCaveColor( v.worldPos, v.nor,fNor,eye,shadow,data);
        }

        if( maxBiomeWeightsID.y == 6 ){
          color2= DoValleyColor( v.worldPos, v.nor,fNor,eye,shadow,data);
        }

        if( maxBiomeWeightsID.y == 7 ){
          color2= DoBaseColor( v.worldPos, v.nor,fNor,eye,shadow,data);
        }
        ...
        if( maxBiomeWeights.y < .001  ){
          
          col = color1;
          }else{

          col = color1 * normalizedBiomeWeights.x;
          col += color2 * normalizedBiomeWeights.y;
        }
        ...
        */
        ...
        col = DoValleyColor( v.worldPos, v.nor,fNor,eye,shadow,data);
