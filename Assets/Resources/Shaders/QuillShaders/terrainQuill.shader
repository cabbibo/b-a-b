Shader "Unlit/quillTerrain"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Tags
            {
                "LightMode" = "ForwardBase" "TerrainCompatible" = "True"
            }
            CGPROGRAM
            #pragma vertex vert
            ...
            */
            ...
            float4 frag( varyings v ) : COLOR
            {
                ...
                if ( control.r < .1 ) { color1 = 0; }
                else { color1 = DoSandColor( v.worldPos , v.nor , fNor , eye , shadow ); }
                if ( control.g < .1 ) { color2 = 0; }
                else { color2 = DoRockColor( v.worldPos , v.nor , fNor , eye , shadow ); }
                if ( control.b < .1 ) { color3 = 0; }
                else { color3 = DoMeadowColor( v.worldPos , v.nor , fNor , eye , shadow ); }
                if ( control.a < .1 ) { color4 = 0; }
                else { color4 = DoForestColor( v.worldPos , v.nor , fNor , eye , shadow ); }
