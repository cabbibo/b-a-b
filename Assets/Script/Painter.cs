...
/*
  ...
  public override void Bind(){
    ...
    life.BindInt(     "_TotalBrushes"    , () => this.verts.dataTypes.Length    );
  ...
  public override void WhileDebug(){
   ...
   // mpb.SetFloat("_Size", 100);
    ...
    if( debug ){
       Graphics.DrawProcedural(debugMaterials[brushType],  new Bounds(transform.position, Vector3.one * 5000), MeshTopology.Triangles, verts.count * 3  , 1, null, mpb, ShadowCastingMode.Off, true, LayerMask.NameToLayer("Debug"));
    }
