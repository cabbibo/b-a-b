    ...
    public class Data : Cycle
    {
        ...
        private Vector3 getWrenPos()
        {
            ...
            if ( t != null ) {
                ...
                return WrenUtils.God.camera.transform.position;
            }
        }


        private Vector3 getWrenForward()
        {
            ...
            if ( t != null ) {
                return WrenUtils.God.wren.physics.vel;
            } else {
                return WrenUtils.God.camera.transform.forward;
            }
        }
        ...
        public void BindCameraData( Life toBind )
        {
            ...
            toBind.BindVector3( "_CameraForward" , () => camera.forward );
            toBind.BindVector3( "_CameraUp" , () => camera.up );
            toBind.BindVector3( "_CameraRight" , () => camera.right );
        }
