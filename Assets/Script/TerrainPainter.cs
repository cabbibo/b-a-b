...
public class TerrainPainter : Simulation
{
    ...
    private string safeName => WrenUtils.God.islandData.name + "_" + gameObject.name;
    ...
    private MeshRenderer paintTipRenderer;

    // to get our data back from gpu
    private Queue<AsyncGPUReadbackRequest> _requests = new();
    ...
    public override void Bind()
    {
        ...
        life.BindVector3( "_PaintPosition" , () => paintPosition );
        life.BindVector3( "_PaintDirection" , () => paintDirection );
        life.BindVector2( "_PaintScreenDirection" , () => paintScreenDirection );
        life.BindFloat( "_PaintSize" , () => paintSize );
        life.BindFloat( "_PaintOpacity" , () => paintOpacity );
        life.BindFloat( "_PaintStrength" , () => paintStrength );
        life.BindFloat( "_Shift" , () => shift );
        life.BindFloat( "_FN" , () => fn );

        life.BindInt( "_WhichBrush" , () => brushType );
        life.BindInt( "_TotalBrushes" , () => verts.dataTypes.Length );

        life.BindFloat( "_Reset" , () => reset );
        life.BindTexture( "_TextureReset" , () => startTexture );
        life.BindTexture( "_UndoTexture" , () => undoTexture );
        life.BindInt( "_Width" , () => verts.width );
    ...
    public void DrawValues()
    {
        ...
        Graphics.DrawProcedural( debugMaterial , new Bounds( transform.position , Vector3.one * 100000 ) , MeshTopology.Triangles ,
            verts.count * debugDrawMultiplier * 3 , 1 , null , mpb , ShadowCastingMode.Off , true , LayerMask.NameToLayer( "Debug" ) );
    ...
    public Texture2D GenerateTexture()
    {
        ...
        var t = new Texture2D( verts.width , verts.width , TextureFormat.RGBAFloat , -1 , true );
