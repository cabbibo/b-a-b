...
namespace Timeline.Samples
{
    ...
    public class VideoPlayableAsset : PlayableAsset, ITimelineClipAsset
    {
        ...
        VideoPlayer CreateVideoPlayer(Camera camera, AudioSource targetAudioSource)
        {
            ...
            videoPlayer.renderMode = VideoRenderMode.RenderTexture;// renderMode == RenderMode.CameraFarPlane ? VideoRenderMode.CameraFarPlane : VideoRenderMode.CameraNearPlane;
