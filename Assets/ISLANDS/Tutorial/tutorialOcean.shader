Shader "Islands/Tutorial/tutorialOcean"
{
    Properties
    {
    ...
    SubShader{
        ...
        Pass
        {
            ...
            fixed4 frag (varyings v) : SV_Target
            {
                ...
                float4 straightSkyColor = UNITY_SAMPLE_TEXCUBE(unity_SpecCube0, -worldViewDir);
                straightSkyColor = float4(DecodeHDR (straightSkyColor, unity_SpecCube0_HDR),1);
                ...
                col = lerp( col ,straightSkyColor.xyz, 1);// )
