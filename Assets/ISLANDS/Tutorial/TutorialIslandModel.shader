...
Shader "Islands/Tutorial/TutorialIslandModel" {
    Properties {
        ...
        Pass{
            ...
            */
            ...
            float4 frag (varyings v) : COLOR {
                ...
                float baryVals = getGrid( v.barycentric, 20 * 3.14159 , .99);

                baryVals = sin(minBary * 3.14159 * 2 * 30);

                //  col = baryVals;

                if( minBary > .01 ){
                    col =0;// col *= .03;//discard;
                }
