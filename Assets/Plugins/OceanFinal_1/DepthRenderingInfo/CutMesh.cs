...
public class CutMesh : MonoBehaviour
{
    ...
    */
    ...
    void Cut( Vector3 position , Vector3 up ){
        ...
        var edgeGroupings = new List<List<edge>>();
    ...
    public void DoAllCuts(){
        ...
        void CheckForNextEdge(List<edge> newEdges, edge startEdge , edge currEdge , List<edge> edgeGroup ){
            ...
            for( int i = 0; i < newEdges.Count; i++){
                ...
                if( (Vector3)currEdge.p2 == (Vector3)e2.p1 ){
                    edgeFound = true;
                    edgeToAdd = e2;
                    
                }

                if( (Vector3)currEdge.p2 == (Vector3)e2.p2 ){
                    edgeFound = true;
                    edgeToAdd = e2;
            ...
            if( edgeFound){
                ...
                if( (Vector3)edgeToAdd.p2 != (Vector3)startEdge.p1 ){
