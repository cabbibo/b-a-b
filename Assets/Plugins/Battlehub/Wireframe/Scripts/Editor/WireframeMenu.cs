...
namespace Battlehub.Wireframe
{
    ...
    {
        private const string m_root = "Battlehub/Wireframe/";
        ...
        [MenuItem("Tools/Wireframe/Prepare")]
        ...
        {
            Undo.RecordObject(c, "Battlehub.Wireframe.PrepareMesh");
        ...
        [MenuItem("Tools/Wireframe/Apply", validate = true)]
        ...
        [MenuItem("Tools/Wireframe/Apply")]
        ...
        {
            Undo.RecordObject(c, "Battlehub.Wireframe.ApplyWireframeMaterial");
        ...
        [MenuItem("Tools/Wireframe/Save Mesh", validate = true)]
        ...
        [MenuItem("Tools/Wireframe/Save Mesh")]
