Shader "FantasyCrystals/ShardShader_NoCenter"
{

    Properties
    {

        _ExplosionValue("ExplosionValue",float) = 0
        _ExplosionSize("ExplosionSize",float) = 10
        _ExplosionType("ExplosionType",int) = 0
      ...
      3.0 ) - 1.0 ) , 0.0 , 1.0 ) ,
            ...
            float4 trace( float3 ro , float3 rd , float iOR )
            {
                ...
                for ( int i = 0; i < _NumSteps; i++ )
                {
                    ...
                    centerOrbDensity = saturate( centerOrbDensity );
                    centerOrbDensity *= 1;
                    centerOrbDensity = 0;
