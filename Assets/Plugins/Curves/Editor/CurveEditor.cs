    ...
    void Draw(){
       ...
       /*
            ...
            */
            ...
            if( curve.showBakedPoints ){
                for( int i = 0; i < curve.bakedPoints.Length; i++){
                    c = Color.HSVToRGB((((float)i/(float)curve.bakedPoints.Length))%1,1,1f);
                    Handles.color = c;
            ...
            */
            ...
            Handles.color = Color.HSVToRGB(.7f,1,1f);
...
*/ 
            ...
            if( i != curve.selectedPoint && curve.showAllControls != true ){
                Handles.color = Color.HSVToRGB(.3f,1,1);//,.5f,1);
                bool hit = Handles.Button( pos , lookAtCam , GetSize( pos , .65f ) , GetSize( pos , .65f ) ,  Handles.CircleHandleCap );
   ...
   if( (i == curve.selectedPoint || curve.showAllControls ) && curve.showMoveControls){
                Handles.color = Color.HSVToRGB(.6f,1,1);
                newPos = Handles.FreeMoveHandle( pos ,GetSize(pos , .3f) , Vector3.zero ,  Handles.CircleHandleCap );
            ...
            if( (i == curve.selectedPoint || curve.showAllControls ) && curve.showRotateControls ){
                ...
                Handles.color = Color.HSVToRGB(0,1,1);
                ...
                Handles.color = Color.HSVToRGB(.1f,1,1);
                ...
                Handles.color = Color.HSVToRGB(.2f,1,1);
            ...
            // Scale Controls
             if( (i == curve.selectedPoint || curve.showAllControls ) && curve.showScaleControls ){
                ...
                Handles.color = Color.HSVToRGB(.4f,1,1);
                size= GetSize( pos,.1f);
                ...
                var fmh_413_56_637940867760234427 = Quaternion.identity; newPos = Handles.FreeMoveHandle(fPos2, handleSize, Vector3.zero, Handles.CircleHandleCap);
                dir = (fPos2 -pos);
               ...
               handleSize = GetSize( fPos2,.1f);
                var fmh_443_56_637940867760249879 = Quaternion.identity; newPos = Handles.FreeMoveHandle(fPos2, handleSize, Vector3.zero, Handles.CircleHandleCap);
                dir = (fPos2 -pos);
                Handles.DrawLine(fPos2 , fPos1);
                    Handles.DrawPolyLine( new []{ 
                    fPos2 - handleSize *forward * 2 - right * outSize * .1f , 
                ...
                Handles.color = Color.HSVToRGB(.5f,1,1);

                fPos1 = pos + right * outSize;
                fPos2 = pos + right * (outSize + curve.powers[i].z);
                
               handleSize = GetSize( fPos2,.1f);
                var fmh_471_56_637940867760253022 = Quaternion.identity; newPos = Handles.FreeMoveHandle(fPos2, handleSize, Vector3.zero, Handles.CircleHandleCap);
                dir = (fPos2 -pos);
                Handles.DrawLine(fPos2 , fPos1);
                Handles.DrawLine(fPos2 , fPos1);
                    Handles.DrawPolyLine( new []{ 
                ...
                handleSize = GetSize( fPos2,.1f);
                var fmh_500_56_637940867760256025 = Quaternion.identity; newPos = Handles.FreeMoveHandle(fPos2, handleSize, Vector3.zero, Handles.CircleHandleCap);
                dir = (fPos2 -pos);
                Handles.DrawLine(fPos2 , fPos1);
                   Handles.DrawLine(fPos2 , fPos1);
                    Handles.DrawPolyLine( new []{ 
...
*/
                ...
                if( curve.showEvenMovementBasis ){
                    Color c = Color.HSVToRGB( (curvePosition * 10+.5f) %1,1,1);
                ...
                if( curve.showCurveMovementBasis ){
                    ...
                    Color c = Color.HSVToRGB( (curvePosition * 10) %1,1,1);
