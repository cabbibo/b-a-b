...
public class SlipStream : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        if (wrenInside != null)
        {
            wrenInside.physics.AddForce(transform.forward * forceMultiplier);
            ...
            wrenInside.physics.AddForce(force , wrenInside.transform.position + wrenInside.transform.forward * rightingForwardAmount );
