...
public class CinematicCameraManager : BaseCameraManager
{
    ...
    public class CinematicCameraDescriptor
    {
        ...
        public enum LockToBirdLocation
        {
            Soul ,
            Head ,
            LeftEye ,
        ...
        public Vector3 osscilationSize = new(0 , 0 , 0);
        ...
        public Vector3            lockBirdOffset     = new(0 , 0 , 0);
    ...
    private void Update()
    {
        ...
        var targetPosition = GetCameraPosition( currentDescriptor );
        var lookPosition = GetCameraLookPosition( currentDescriptor );
        var lookUp = GetCameraLookUp( currentDescriptor );
    ...
    public Vector3 GetOrbitPosition( CinematicCameraDescriptor cam )
    {
        ...
        var center = cam.orbitCenter.position;
        var axis = cam.orbitAxis.normalized;
    ...
    {
        var pos = cam.locationTarget.position;
    ...
    {
        var pos = God.wren.transform.position;
    ...
    public Vector3 GetLockToBirdPosition( CinematicCameraDescriptor cam )
    {
        ...
        var pos = GetBirdPosition( cam );

        var offset = cam.lockBirdOffset;
    ...
    public CinematicCameraDescriptor LerpDescriptors( CinematicCameraDescriptor a , CinematicCameraDescriptor b ,
        float t )
    {
        var c = new CinematicCameraDescriptor();
