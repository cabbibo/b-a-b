...
public class Activity : MonoBehaviour
{
    ...
    public bool completed => numTimesCompleted > 0;
    ...
    */
    ...
    public Helpers.FloatEvent OnAddedToCompletionEvent;
    ...
    [Header( "State Events" )]
    public UnityEvent SetStateEvent;

    public UnityEvent SetBaseStateEvent;
    public UnityEvent SetDiscoveredStateEvent;
    public UnityEvent SetStartedStateEvent;
    public UnityEvent SetCompletedStateEvent;
    public UnityEvent SetFullCompletedStateEvent;
    ...
    public string GetFullName()
    {
        ...
        if ( uniqueID == "" ) {
            ...
            uniqueID = uid; // holy shit so spooky and hacky
        }

        return activityName + " " + uniqueID;
    }
    ...
    public void Initialize()
    {
        ...
        fullName = GetFullName(); //activityName + " " + uniqueID;
    ...
    {
        SetBaseStateEvent.Invoke();
    }

    public void SetDiscoveredState()
    {
        SetDiscoveredStateEvent.Invoke();
    }

    public void SetStartedState()
    {
        SetStartedStateEvent.Invoke();
    }

    public void SetCompletedState()
    {
        SetCompletedStateEvent.Invoke();
    }

    public void SetFullCompletedState()
    {
        SetFullCompletedStateEvent.Invoke();
    }
...
*/
    ...
    public void AddToComplete( float v )
    {
        ...
        if ( !currentlyComplete ) {
            ...
            OnAddedToCompletionEvent.Invoke( currentAmountComplete );
    ...
    public void SetCompleteAmount( float v )
    {
        if ( !currentlyComplete ) {
