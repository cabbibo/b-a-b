...
//        print( "hi" );
    ...
    public struct Grain
    {
        ...
        private Grain( int startPositionInSample , int currentPositionInSample , int fPositionInSample , float playbackSpeed ,
            int totalNumberOfSamples , float loudness , float leftRightBlend )
        {
    ...
    private int   fPositionInSampleCeil;
    private int   fPositionInSampleFloor;

    private float fPositionInSample;
    private float nInSample;
    private float env;
            ...
            lock (grains) {
                ...
                while (n < dataLen) {
                    for ( int i = 0; i < tmpGrains.Count; i++ ) {
                        ...
                        fPositionInSample = ((float)g.startPositionInSample + g.currentPositionInSample) %
                                            ((float)sampleLengths[g.clipID] / 2);
