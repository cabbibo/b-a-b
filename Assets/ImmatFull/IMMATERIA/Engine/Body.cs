...
public class Body : Cycle {
  ...
  public override void _WhileLiving(float v ){
   ...
   if( active ){
    ...
    Graphics.DrawProcedural(material,  new Bounds(transform.position, Vector3.one * 500000), MeshTopology.Triangles, triangles.count , 1, null, mpb, ShadowCastingMode.On, true, gameObject.layer);
  }
  }
