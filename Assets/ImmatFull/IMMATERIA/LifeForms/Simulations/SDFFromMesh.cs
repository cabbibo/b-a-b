...
public class SDFFromMesh : Simulation
{
  ...
  public override void Bind(){
    ...
    if( transformVerts ){
      life.BindMatrix("_VertTransform", () => mesh.gameObject.transform.localToWorldMatrix );
      life.BindMatrix("_VertInverseTransform", () => mesh.gameObject.transform.worldToLocalMatrix );
    }
    ...
    if( transformVerts ){
      finalLife.BindMatrix("_VertTransform", () => mesh.gameObject.transform.localToWorldMatrix );
      finalLife.BindMatrix("_VertInverseTransform", () => mesh.gameObject.transform.worldToLocalMatrix );
    }
